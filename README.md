...
| 2 | `Variaveis.py` | Introdução às variáveis, atribuição de valores, múltiplas atribuições e regras de nomenclatura. | [Acesser](https://github.com/MuriloAlvesII/Gradus-Unus/blob/main/Variaveis.py) |
<!--
